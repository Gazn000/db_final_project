...
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(id, @age, gender, height, weight, @ap_hi, @ap_lo, cholesterol, gluc, smoke, alco, active, cardio, age_years, bmi, bp_category, @bp_category_encoded);  -- 根據 CSV 中的欄位順序對應到 MySQL 表格的列
